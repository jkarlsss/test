...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.settings.layout','data' => ['heading' => __('Manage'),'subheading' =>  __('Manage your database')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['heading' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Manage')),'subheading' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute( __('Manage your database'))]); ?>
...
<?php endif; ?>
</div><?php /**PATH C:\Users\jkarls\Herd\test_web_new\resources\views\livewire/settings/manage.blade.php ENDPATH**/ ?>